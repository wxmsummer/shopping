...
func (x *Comment) GetOrderID() int32 {
	if x != nil {
		return x.OrderID
	}
	return 0
...
func (x *GetCommentsByProductIdReq) GetProductID() int32 {
	if x != nil {
		return x.ProductID
	}
	return 0
...
func (x *GetCommentByOrderIdReq) GetOrderID() int32 {
	if x != nil {
		return x.OrderID
	}
	return 0
...
var file_proto_comment_comment_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x44, 0x22, 0x81,
